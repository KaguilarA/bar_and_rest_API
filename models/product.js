...
export default class ProductModelMySQL extends BaseModel {
  ...
  constructor({
    ...
    super({ id, name, description, images, state, date_created, date_updated });
    this.type = type;
   ...
   */
  get registerParams() {
    return [this.name, this.description, this.stock, this.price, this.state, this.type, this.author_id];
  }
   ...
   */
  get updateParams() {
    return [this.id, this.name, this.type, this.stock, this.price];
  }
